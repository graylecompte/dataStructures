...
Description: This program implements a hash table using a linked list or a
    binary search tree for collision resolution. A list of student id's and names
    will be read and inserted into the hash table. After the names have been
    inserted the file will close, a new file with just id's will be read and the hash
    table will be searched to retrieve the respective id's and student names. Time
    will be tracked for bot the insert and retrieval in order to compare the two
    operations.
"""
